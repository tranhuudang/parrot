      ...
      children: [
        ...
        Row(
          children: [
            ...
            8.width,
            ElevatedButton(
              onPressed: state.isDownloading ? null : () => notifier.downloadFlutterVersion(),
        ...
        Row(
          children: [
            ...
            8.width,
            ElevatedButton(
              onPressed: state.isSwitching ? null : () => notifier.switchFlutterVersion(notifier.projectPathController.text),
